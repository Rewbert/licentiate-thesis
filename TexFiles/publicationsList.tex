...
\begin{enumerate}[align=left,label={[\textbf{Paper \Roman*}]}]
    ...
    \pubitem{A.~Sarkar, \textbf{R.~Krook},K.~Claessen,A.~Russo}{HasTEE: Confidential Computing on Trusted Execution Environments with Haskell}{\textcolor{red}{In submission to ICFP 2023}}
